...
0000000000001060 <_start>:
    ...
    1078:	48 8d 3d e6 00 00 00 	lea    0xe6(%rip),%rdi        # 1165 <main>
...
0000000000001149 <fill_my_struct>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	55                   	push   %rbp
    114e:	48 89 e5             	mov    %rsp,%rbp
    1151:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    1155:	c7 45 f8 04 00 00 00 	movl   $0x4,-0x8(%rbp)
    115c:	66 c7 45 fc 10 00    	movw   $0x10,-0x4(%rbp)
    1162:	90                   	nop
    1163:	5d                   	pop    %rbp
    1164:	c3                   	ret    
...
0000000000001165 <main>:
    ...
    1182:	e8 c9 fe ff ff       	call   1050 <puts@plt>

    1187:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    118b:	48 89 c7             	mov    %rax,%rdi
    118e:	e8 b6 ff ff ff       	call   1149 <fill_my_struct>
